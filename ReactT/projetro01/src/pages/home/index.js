...
export default function Index(){
    ...
    <div className='container2'> 
      ...
      <div className='subcontainer4' >
          ...
          <div>
            <img className='img2' src='./image/Mental health-rafiki.png' alt=''/>
          </div>
    </div>
    </div>
   ...
   <div class="c">
    ...
    <div>
      <div  className='content'>
        <div className='card'>
               <div >
                   <h2 >Promover Autoconhecimento</h2>
    ...
    <div  class="content">
            ...
            <div className='cardx'>
              <div >
                  <h2 >Tratamentos para transtorno mentais</h2>
